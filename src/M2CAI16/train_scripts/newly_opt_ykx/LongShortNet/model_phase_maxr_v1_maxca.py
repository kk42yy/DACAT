...
class TemporalCNN(nn.Module):
	...
	def __init__(self,out_size,backbone,head,opts,do_lstm=True,cache_size=None,CA=False,train=False):
	...
	def forward(self,x,long_term=None):
		...
		if long_term is not None:
			# 20240718 max-response
			# fs_t: [1, 1, 768], [f_1...f_t] = [1, t, 768]
			# # infer code
			if not self.trainee:
