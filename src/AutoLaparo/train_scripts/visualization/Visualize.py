...
if __name__ == "__main__":
    # p = '/memory/yangkaixiang/SurgicalSceneUnderstanding/pitfalls_bn/output/predictions/phase/'
    # p += '20240701-1706_trial_cuhknotestSplit_lstm_convnextv2_lr0.0001_bs1_seq256_frozen'
    # suffixpred = '_on8192'
